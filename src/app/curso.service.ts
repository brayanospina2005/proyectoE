...
export class CursoService {
  ...
  defaultImageUrl = "https://images.unsplash.com/photo-1543858828-7cf1a9beb95c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80";
  ...
  agregarCurso(Curso: cursosInfo) {
    Curso.Image = this.defaultImageUrl;
